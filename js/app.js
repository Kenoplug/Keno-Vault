...
function renderScoreRecommendations(s, opt) {
  ...
  if (!hasInvest)
    recs.push({ priority:'high', icon:'📈', title:'Start investing — your wealth is not growing',
      desc:'You have zero investment exposure. Even modest allocations to index funds, fixed income, or crypto can compound significantly over time. Start with as little as ' + curSym() + '100.' });
  else if (invest < 15)
